...
void implicit_surface_structure::update_marching_cube()
{
...
void implicit_surface_structure::update_field(field_function_structure const& field_function)
{
	// Variable shortcut
